<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Proje.Site.Default" %>
    ...
    <div class="hero-container">
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background: url(/Template/assets/img/slide/slide-1.jpg);">
          ...
          <!-- Slide 2 -->
          <div class="carousel-item" style="background: url(/Template/assets/img/slide/slide-2.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item" style="background: url(/Template/assets/img/slide/slide-3.jpg);">
            <div class="carousel-background"><img src="/Template/assets/img/slide/slide-3.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">
